...
(function() {
  var Collection, Database, Model, d3, findFiles, fs;
  ...
  Database = (function() {
    function Database(path, models, options) {
      if (options == null) {
        options = {};
      }
      this.models = models;
    ...
    Database.prototype.save = function(model, file, callback) {};
    ...
    Database.prototype.loadFile = function(model, file, callback) {
      ...
      return collection.read(callback);
    };
  ...
  Collection = (function() {
    function Collection(options) {
      ...
      this.parser = this._getParser(this.db.separator);
    }
    ...
    Collection.prototype.read = function(callback) {
      return fs.readFile(this.file, {
        ...
        return function(e1, data) {
          ...
          console.log("parsing");
          try {
            _this.model.load(_this.id, data);
          } catch (_error) {
            e3 = _error;
            throw e3;
            callback({
  ...
  Model = (function() {
    ...
    Model.prototype.load = function(collectionId, data) {
